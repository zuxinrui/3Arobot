...
#ifdef DOBOT
	#define QUICK_HOME //DOBOT needs Quickhome
#endif
...
#ifdef ULTIPANEL
#define MANUAL_FEEDRATE {50*60, 50*60, 10*60, 60}  // set the speeds for manual moves (mm/min) 手动操作时的速度
#endif
...
// MS1 MS2 Stepper Driver Microstepping mode table 细分数这里也可以定义！很神奇！
